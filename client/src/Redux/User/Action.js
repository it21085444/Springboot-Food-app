...
export const getUserProfileAction = (token) => async (dispatch) => {
  try {
    const res = await fetch("http://localhost:8000/api/users/req", {
      method: "GET",
...
export const findByUsernameAction = (data) => async (dispatch) => {
  ...
  try {
    const res = await fetch(
      `http://localhost:8000/api/users/username/${data.username}`,
      {
        method: "GET",
...
export const findByUserIdsAction = (data) => async (dispatch) => {
  try {
    const res = await fetch(
      `http://localhost:8000/api/users/m/${data.userIds}`,
      {
        method: "GET",
...
export const followUserAction = (data) => async (dispatch) => {
  try {
    const res = await fetch(
      `http://localhost:8000/api/users/follow/${data.userId}`,
      {
        method: "PUT",
...
export const unFollowUserAction = (data) => async (dispatch) => {
  try {
    const res = await fetch(
      `http://localhost:8000/api/users/unfollow/${data.userId}`,
      {
        method: "PUT",
...
export const searchUserAction = (data) => async (dispatch) => {
  ...
  try {
    const res = await fetch(
      `http://localhost:8000/api/users/search?q=${data.query}`,
      {
        method: "GET",
...
export const editUserDetailsAction = (data) => async (dispatch) => {
  ...
  try {
    const res = await fetch(`http://localhost:8000/api/users/account/edit`, {
      method: "PUT",
...
export const deleteUserAction = (data) => async (dispatch) => {
  try {
    const res = await fetch(
      `http://localhost:8000/api/users/delete/${data.userId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
